...
soundManager.setup({
  url: 'SOUND/swf/', // path to load SWF from (overriding default)
  bgColor: '#333333',
  wmode: 'transparent',
  debugMode: false,
  preferFlash: false,
  ...
  onready: function() {
    ...
    var soundURLs = 'pac man chomp,Mii,pacman_death,mmTheme,Wha-Wha,fanfare,countDown,click,Level Up'.split(',');
    for (var i=0; i<soundURLs.length; i++) {
      soundManager.createSound({
        id: 's'+i,
        url: 'SOUND/audio/'+soundURLs[i]+'.mp3'
      });
    }
